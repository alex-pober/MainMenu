    ...
    const addWrappedText = (
      ...
      if (align === "center") {
        lines.forEach((line: string) => {
          const textWidth =
            (pdf.getStringUnitWidth(line) * fontSize) /
    ...
    data.menus.forEach((menu) => {
      ...
      menu.menu_categories
        ...
        .forEach((category: any) => {
          ...
          const catWidth =
            (pdf.getStringUnitWidth(catText) * 18) / pdf.internal.scaleFactor;

          // Draw decorative lines around category
          const lineLength = 50;
          pdf.line(
            centerX - catWidth / 2 - lineLength,
            y,
            centerX - catWidth / 2 - 10,
            y
          );
          pdf.line(
            centerX + catWidth / 2 + 10,
          ...
          category.menu_items
            ...
            .forEach((item: any) => {
              ...
              const nameWidth =
                (pdf.getStringUnitWidth(itemName) * 12) /
                pdf.internal.scaleFactor;
              const priceWidth =
                (pdf.getStringUnitWidth(itemPrice) * 12) /
                pdf.internal.scaleFactor;
